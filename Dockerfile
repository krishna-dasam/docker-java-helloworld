...
CMD ["java", "-cp", "/usr/local/docker-git-hello-world/target/docker-java-helloworld-0.0.1-SNAPSHOT-jar-with-dependencies.jar", "org.cynos.HelloWorldPing"]
